...
if __name__ == "__main__":
    ...
    pprint.pprint(m.run())
    m = MassSimulationAnalyzer("/Users/smcho/Desktop/reports/reports/light_trees")
    pprint.pprint(m.run())
    # some missing values for light_meshes do once more later
    #m = MassSimulationAnalyzer("/Users/smcho/Desktop/reports/reports/light_meshes")
    pprint.pprint(m.run())